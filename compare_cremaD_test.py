...
def args():
    ...
    parser.add_argument("--audio_pretrained_model_file", required=True, type=str)
    parser.add_argument("--video_pretrained_model_file", required=True, type=str)
...
def test(args):
    ...
    trained_model_path = f"./saved_models/compare_cremaD/{args.trained_model_file}"
